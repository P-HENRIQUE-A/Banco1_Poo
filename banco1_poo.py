...
def recuperar_conta_cliente(cliente):
    ...
    for i, conta in enumerate(cliente.contas, start=1):
        print(f"[{i}] {conta.__class__.__name__} - Agência: {conta.agencia}, Número: {conta.numero}")
...
def criar_conta(numero_conta, clientes, contas):
    ...
    tipo = input("Informe o tipo de conta ([c]orrente / [p]oupança): ").lower()
    if tipo == "p":
